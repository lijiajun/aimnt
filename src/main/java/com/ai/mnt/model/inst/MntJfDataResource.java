...
public class MntJfDataResource implements Serializable{
    ...
    /**业务是否下线*/
    private String isOfflineTxt;

    /**是否送计费*/
    private String isToJfTxt;

    /**是否需要处理*/
    private String isNeedDealTxt;
    ...
    public String getIsOfflineTxt() {
        return isOfflineTxt;
    }

    public void setIsOfflineTxt(String isOfflineTxt) {
        this.isOfflineTxt = isOfflineTxt;
    }

    public String getIsToJfTxt() {
        return isToJfTxt;
    }

    public void setIsToJfTxt(String isToJfTxt) {
        this.isToJfTxt = isToJfTxt;
    }

    public String getIsNeedDealTxt() {
        return isNeedDealTxt;
    }

    public void setIsNeedDealTxt(String isNeedDealTxt) {
        this.isNeedDealTxt = isNeedDealTxt;
    }
