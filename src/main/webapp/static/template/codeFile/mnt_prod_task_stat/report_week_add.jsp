                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="processingNum" id="processingNum">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="finishedNum" id="finishedNum">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="date-picker form-control" readonly data-date-format="yyyy-mm-dd" name="earlSubmTimeUnfinished" id="earlSubmTimeUnfinished">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="cycle" id="cycle">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="date-picker form-control" readonly data-date-format="yyyy-mm-dd" name="cycleBeginDate" id="cycleBeginDate">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="date-picker form-control" readonly data-date-format="yyyy-mm-dd" name="cycleEndDate" id="cycleEndDate">
                                            <div class="form-control-focus"></div>
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'report/week/add', 'add');
