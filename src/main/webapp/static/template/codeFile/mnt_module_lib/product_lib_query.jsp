                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">库文件名称</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">库文件描述</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="libDesc">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabMntModuleLib" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        $('.reload').on('click', function() {
            ...
            $('#modifier').val('');
            $('#modifyDate').val('');
            tableObj.ajax.url('product/lib/query?libId=-1').load();
        });
        
        //修改按钮
        $('#btnUpdate').on('click',function() {
            var checkedBox = $("#tabMntModuleLib tbody tr td .checked");
            ...
            showModal(2, "修改发布信息", [ '650px', '500px' ], "product/lib/update_page/" + strLibId, tableObj);
        });
        
        //新增
        $('#btnAdd').on('click', function(){
            showModal(2, " ", ['650px', '500px'], "product/lib/add_page", tableObj);
        });
        ...
        $('#btnDelete').on('click',function() {
            ...
            $.ajax({
                url: 'product/lib/delete/' + libIdAry,
                dataType: 'json',
                async:false,
