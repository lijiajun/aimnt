                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">团队编号</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">团队英文名称</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="teamNameEn">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">团队中文名称</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="teamNameCn">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabMntTeamType" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabMntTeamType').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strTeamId = $("#teamId").val();
            var strTeamNameEn = $("#teamNameEn").val();
            var strTeamNameCn = $("#teamNameCn").val();
            var sUrl = "report/week/query?";
            sUrl += 
                "&teamId=" + strTeamId +
                "&teamNameEn=" + strTeamNameEn +
                "&teamNameCn=" + strTeamNameCn;
        ...
        $('.reload').on('click', function() {
            ...
            $('#teamNameEn').val('');
            $('#teamNameCn').val('');
            tableObj.ajax.url('report/week/query?teamId=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabMntTeamType tbody tr td .checked");
            ...
            var strTeamId = checkedBox.find('input:checkbox').val();
            showModal(2, " ", [ '1000px', '500px' ], "report/week/update_page/" + strTeamId, tableObj);
        });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "report/week/query?teamId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "teamId"
