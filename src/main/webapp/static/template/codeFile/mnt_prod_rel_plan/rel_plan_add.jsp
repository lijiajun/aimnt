                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="date-picker form-control" readonly data-date-format="yyyy-mm-dd" name="planDate" id="planDate">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="reqNo" id="reqNo">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="reqName" id="reqName">
                                            <div class="form-control-focus"></div>
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'rel/plan/add', 'add');
