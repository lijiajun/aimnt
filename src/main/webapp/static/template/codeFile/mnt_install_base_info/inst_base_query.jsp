                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="buId">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">安装点描述</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="baseDesc">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabMntInstallBaseInfo" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabMntInstallBaseInfo').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strBaseId = $("#baseId").val();
            var strBaseName = $("#baseName").val();
            var strBuId = $("#buId").val();
            var strBaseDesc = $("#baseDesc").val();
        ...
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabMntInstallBaseInfo tbody tr td .checked");
            ...
            showModal(2, " ", [ '1000px', '500px' ], "inst/base/update_page/" + strBaseId, tableObj);
        });
        
        //新增
        $('.div_right').on('click', '.dt-buttons>#btnAdd', function(){
            showModal(2, " ", ['1000px', '500px'], "inst/base/add_page", tableObj);
        });
