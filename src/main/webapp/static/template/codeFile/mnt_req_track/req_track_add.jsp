                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="trackId" id="trackId">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="dealDays" id="dealDays">
                                            <div class="form-control-focus"></div>
                                            <span class="help-block">请输入处理时长(天)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'req/track/add', 'add');
