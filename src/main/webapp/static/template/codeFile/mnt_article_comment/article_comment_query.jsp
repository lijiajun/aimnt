                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">评论ID</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">文章ID</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="aritcleId">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">评论人姓名</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">评论上级</label>
                                    <div class="col-md-8">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabMntArticleComment" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabMntArticleComment').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strCommentId = $("#commentId").val();
            var strAritcleId = $("#aritcleId").val();
            var strUserName = $("#userName").val();
            var strCommentContent = $("#commentContent").val();
            var strCommentDate = $("#commentDate").val();
            var strParentId = $("#parentId").val();
            var sUrl = "article/comment/query?";
            sUrl += 
                "&commentId=" + strCommentId +
                "&aritcleId=" + strAritcleId +
                "&userName=" + strUserName +
                "&commentContent=" + strCommentContent +
                "&commentDate=" + strCommentDate +
        ...
        $('.reload').on('click', function() {
            ...
            $('#commentDate').val('');
            $('#parentId').val('');
            tableObj.ajax.url('article/comment/query?commentId=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabMntArticleComment tbody tr td .checked");
            ...
            var strCommentId = checkedBox.find('input:checkbox').val();
            showModal(2, " ", [ '1000px', '500px' ], "article/comment/update_page/" + strCommentId, tableObj);
        });
        
        //新增
        $('.div_right').on('click', '.dt-buttons>#btnAdd', function(){
            showModal(2, " ", ['1000px', '500px'], "article/comment/add_page", tableObj);
        });
        
        //删除按钮
        $('.div_right').on('click', '.dt-buttons>#btnDelete',function() {
            var checkedBox = $("#tabMntArticleComment tbody tr td .checked");
            comfirmDeleteData(tableObj, checkedBox, 'article/comment/delete/');
        });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "article/comment/query?commentId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "commentId"
