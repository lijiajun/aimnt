                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="summary" id="summary">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="readCount" id="readCount">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="commentCount" id="commentCount">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="allowComment" id="allowComment">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="isTop" id="isTop">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="isShow" id="isShow">
                                            <div class="form-control-focus"></div>
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'article/posts/add', 'add');
