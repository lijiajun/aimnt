                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="onlineId" id="onlineId">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="moduleId" id="moduleId">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="isOnsiteSupport" id="isOnsiteSupport">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="isRemoteSupport" id="isRemoteSupport">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="isOnlined" id="isOnlined">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="unOnlineReason" id="unOnlineReason">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="onlineRemark" id="onlineRemark">
                                            <div class="form-control-focus"></div>
