                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="relLibId">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(function() {
        ...
        $('#btnQuery').click(function(e) {
            ...
            var sUrl = "product/lib_relation/query?";
            sUrl += 
                "&id=" + strId +
                "&libId=" + strLibId +
                "&relLibId=" + strRelLibId +
                "&relDesc=" + strRelDesc +
        ...
        $('.reload').on('click', function() {
            ...
            $('#modifier').val('');
            $('#modifyDate').val('');
            tableObj.ajax.url('product/lib_relation/query?id=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabMntLibRelation tbody tr td .checked");
            ...
            showModal(2, "修改发布信息", [ '650px', '500px' ], "product/lib_relation/update_page/" + strId, tableObj);
        });
        
        //新增
        $('.div_right').on('click', '.dt-buttons>#btnAdd', function(){
            showModal(2, " ", ['650px', '500px'], "product/lib_relation/add_page", tableObj);
        });
        ...
        $('.div_right').on('click', '.dt-buttons>#btnDelete',function() {
            ...
            $.ajax({
                url: 'product/lib_relation/delete/' + idAry,
                dataType: 'json',
                async:false,
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "product/lib_relation/query?id=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "id"
