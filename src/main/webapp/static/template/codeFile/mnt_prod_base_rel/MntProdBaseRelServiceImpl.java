...
public class MntProdBaseRelServiceImpl implements MntProdBaseRelService{
    ...
    public void saveMntProdBaseRel(MntProdBaseRel mntProdBaseRel) {
        ...
        mntProdBaseRel.setDeleteFlag("0");
        mntProdBaseRel.setCreator(currentUser.getUserName());
        mntProdBaseRel.setModifier(currentUser.getUserName());
        mntProdBaseRel.setCreateDate(new Date());
        mntProdBaseRel.setModifyDate(new Date());
    ...
    public void deleteMntProdBaseRelByIds(String ids) {
        ...
        mntProdBaseRel.setDeleteFlag("1");
        mntProdBaseRel.setModifier(currentUser.getUserName());
        mntProdBaseRel.setModifyDate(new Date());
