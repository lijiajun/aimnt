                ...
                <div class="wrapper-body">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <i class="icon-layers font-green"></i> <span class="caption-subject bold uppercase"> 新增产品安装点映射 </span>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <span class="help-block">请输入序号</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'inst/prodbase/add', 'add');
