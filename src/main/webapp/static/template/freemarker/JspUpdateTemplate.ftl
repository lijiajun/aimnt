                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="date-picker form-control" readonly data-date-format="yyyy-mm-dd" 
                                                value="<fmt:formatDate value="${'${'}${modelName?uncap_first}.${column.javaField}}" pattern="yyyy-MM-dd"/>" name="${column.javaField}" id="${column.javaField}">
                                            <#else>
                                            <input type="text" class="form-control" placeholder="" value="${'${'}${modelName?uncap_first}.${column.javaField}}" name="${column.javaField}" id="${column.javaField}">
                                            </#if>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-9 model-hidden">
                                        <input type="hidden" value="${'${'}${modelName?uncap_first}.${pkJavaField}}" name="${pkJavaField}" id="${pkJavaField}">
                                    </div>
                                </div>
                            </div>
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-update', rules, '${module}/${sub_module}/update', 'update');
