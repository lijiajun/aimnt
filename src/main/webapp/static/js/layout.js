...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar').on('click', 'li > a.nav-link', function (e) {
            e.preventDefault();
            App.scrollTop();
            var url = $(this).attr("href");
            
            if (url.toLowerCase() === 'javascript:;' || url.toLowerCase() === '#' || url.toLowerCase() === '') {
                return;
            }   
            var menuContainer = $('.page-sidebar ul');
            var pageContent = $('.page-content');
            ...
            $("#page-content-frame").attr("src", url);
            ...
            handleSidebarMenuActiveLink("click", the);
            
            App.stopPageLoading();
        });
        
        $('.dropdown-menu').on('click', 'li > a.priv-page', function (e) {
            e.preventDefault();
            App.scrollTop();
            var url = $(this).attr("href");
            if (url.toLowerCase() === 'javascript:;' || url.toLowerCase() === '#' || url.toLowerCase() === '') {
            ...
            var the = $(this);
            $("#page-content-frame").attr("src", url);
            $("#title-txt").html($(this).children("span").html());
            App.stopPageLoading();
        });
