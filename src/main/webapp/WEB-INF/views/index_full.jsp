...
<html>
    ...
    <head>
        ...
        <link href="static/css/themes/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="static/img/favicon.ico" /> 
    
    <style>
    body, .list-heading {
        font-family: "Open Sans","sans-serif","Arial","Microsoft YaHei","黑体","宋体",sans-serif;  
    }
    ...
    .media-list.list-items>li>select.form-control {
        display: inline;
        width: 120px;
        padding: 2px;
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="static/img/mnt_log.png" alt="logo" class="logo-default" /> </a>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> 小明 </span>
        ...
        <div class="page-container">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item ">
                                            <a href="ui_page_progress_style_1.html" class="nav-link "> 三级菜单1 </a>
                                        </li>
                                        <li class="nav-item ">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> 500 Page Option 1
            ...
            <div class="page-quick-sidebar-wrapper" data-close-on-body-click="false">
                <div class="page-quick-sidebar">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="javascript:;" data-target="#quick_sidebar_tab_1" data-toggle="tab"> 主题
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                <h3 class="list-heading">颜色</h3>
                                <ul class="media-list list-items">
                                    <li class="color-darkblue">Dark Blue</li>
                                    <li class="color-grey tooltips" data-style="grey" data-container="body" data-original-title="Grey">Grey</li>
                                    <li class="color-light tooltips" data-style="light" data-container="body" data-original-title="Light">Light</li>
                                    <li class="color-light2 tooltips" data-style="light2" data-container="body" data-html="true" data-original-title="Light 2">Light 2 </li>
                                </ul>
                                <h3 class="list-heading">样式</h3>
                                <ul class="media-list list-items">
                                     <li>
                                        <span> 顶部固定 </span>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2020 &copy;
                <a href="#" title="#" target="_blank">MNT!</a>
            </div>
        ...
        <script src="static/plugin/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
        <script src="static/plugin/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
