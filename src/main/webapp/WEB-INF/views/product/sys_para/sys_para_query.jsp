...
//             $('#verCode').val('');
//             $('#relCode').val('');
            tableObj.ajax.url('prod/sys_para/query?paraId=-1').load();
        });
        ...
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            ...
            showModal(2, "修改发布信息", [ '1000px', '500px' ], "prod/sys_para/update_page/" + strParaId, tableObj);
        });
        
        //新增
        $('.div_right').on('click', '.dt-buttons>#btnAdd', function(){
            showModal(2, " ", ['1000px', '500px'], "prod/sys_para/add_page", tableObj);
        });
        ...
        $('.div_right').on('click', '.dt-buttons>#btnDelete',function() {
            ...
            var checkedBox = $("#tabSysPara tbody tr td .checked");
            comfirmDeleteData(tableObj, checkedBox, 'prod/sys_para/delete/');
...
//             });
//             $.ajax({
//                 url: 'prod/sys_para/delete/' + paraIdAry,
//                 dataType: 'json',
//                 async:false,
...
//             });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "prod/sys_para/query?paraId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "paraId"
