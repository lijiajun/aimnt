        ...
        <div class="wrapper-content">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class=" icon-layers font-green"></i> <span class="caption-subject bold uppercase"> 发布明细导入 </span>
                </div>
            </div>
            <div class="portlet-body">
                <form action="#"  method="post" enctype="multipart/form-data" class="form-horizontal" id="form-upload">
                    <div class="row">
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10 form-group">
                                <a id="templete" href="javascript:void(0)">发布明细模板</a>
                            </div>
                        </div>
                    </div>
                </form>
