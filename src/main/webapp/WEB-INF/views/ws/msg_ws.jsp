...
<script>
    ...
    if ('WebSocket' in window) {
    	sock = new WebSocket("ws://localhost:8080/aimnt/msg");
    	console.log('WebSocket');
    }else if ('MozWebSocket' in window) {
    	sock = new MozWebSocket("ws://localhost:8080/aimnt/msg");
    	console.log('MozWebSocket');
    }else {
    	sock = new SockJS("http://localhost:8080/aimnt/msg");
    	console.log('SockJS');
    }
